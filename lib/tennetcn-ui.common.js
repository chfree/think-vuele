...
var buttonvue_type_template_id_ca859fb4_render = function() {
  ...
  return _c(
    ...
    _vm._g(
      _vm._b(
        { staticClass: "tc-button", attrs: { vevent: "vevent" } },
        "el-button",
        _vm.$attrs,
        false
      ),
...
var handsontable_full_css_ = __webpack_require__(12);

// EXTERNAL MODULE: ./packages/hot-table/src/hot-table.css
var hot_table = __webpack_require__(13);
...
var external_libphonenumber_js_ = __webpack_require__(7);
...
var vue_tags_input_ = __webpack_require__(8);
...
/* harmony default export */ var input_tagvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.initTags = this.initTags.map(function (item) {
      return {
        text: item
      };
    });
...
var external_xgplayer_vue_ = __webpack_require__(9);
