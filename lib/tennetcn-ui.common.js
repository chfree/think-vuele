...
var buttonvue_type_template_id_ca859fb4_render = function() {
  ...
  return _c(
    "el-button",
    _vm._g(
      _vm._b({ staticClass: "tc-button" }, "el-button", _vm.$attrs, false),
      _vm.$listeners
    ),
    [_vm._t("default")],
    2
...
var checkboxvue_type_template_id_d0387074_render = function() {
  ...
  return _c(
    ...
    _vm._g(
      _vm._b(
        { staticClass: "tc-checkbox", attrs: { value: _vm.value } },
        "el-checkbox",
        _vm.$attrs,
        false
      ),
...
var inputvue_type_template_id_343dd774_render = function() {
  ...
  return _c(
    ...
    _vm._g(
      _vm._b(
        { staticClass: "tc-input", attrs: { value: _vm.value } },
        "el-input",
        _vm.$attrs,
        false
      ),
...
var input_numbervue_type_template_id_42f8cf66_render = function() {
  ...
  return _c(
    ...
    _vm._g(
      _vm._b(
        { staticClass: "tc-input-number", attrs: { value: _vm.value } },
        "el-input-number",
        _vm.$attrs,
        false
      ),
...
var validators = {
  ...
  methods: {
    ...
    addNew: function addNew(e) {
      ...
      var tag = this.beforeAdding ? this.beforeAdding(this.newTag) : this.newTag;
      var isValid = this.validateIfNeeded(tag);
...
var letter_avatarvue_type_template_id_1f417ef2_render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("svg", { style: _vm.svgStyle }, [
    _c(
      "text",
      {
        style: _vm.textStyle,
...
/* harmony default export */ var letter_avatarvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    svgStyle: function svgStyle() {
      ...
      var letterIndex = this.avatarLetter.charCodeAt() - 64;
...
var radiovue_type_template_id_69cd6268_render = function() {
  ...
  return _c(
    ...
    _vm._g(
      _vm._b(
        { staticClass: "tc-radio", attrs: { value: _vm.value } },
        "el-radio",
        _vm.$attrs,
        false
      ),
...
var switchvue_type_template_id_2e631ae6_render = function() {
  ...
  return _c(
    "el-switch",
    _vm._g(
      _vm._b({ staticClass: "tc-swtich" }, "el-switch", _vm.$attrs, false),
      _vm.$listeners
    )
  )
}
...
var components = [util_lib, packages_badge, packages_block, packages_button, packages_button_group, packages_checkbox, packages_date_picker, packages_date_time_picker, packages_dialog, packages_edit_table, packages_edit_tree_table, packages_fieldset, packages_fixed_bottom, packages_form, packages_form_item, packages_hot_table, packages_input, packages_input_number, packages_input_tag, packages_letter_avatar, packages_pager, packages_radio, packages_select, packages_switch, packages_table, packages_tabs, packages_tag, packages_time_picker, packages_tree, packages_tree_table, packages_xg_player];
